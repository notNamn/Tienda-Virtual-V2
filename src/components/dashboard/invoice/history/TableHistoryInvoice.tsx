...
type TableHistoryInvoiceProps = {
    invoices: Invoice[];
}

export default function TableHistoryInvoice({ invoices }: TableHistoryInvoiceProps) {
    return (
                                ...
                                <td className="px-6 py-4 whitespace-nowrap">
                                    <div className="flex items-center space-x-4">
                                        <Link
                                            ...
                                            href={`/dashboard/invoices/view/${sale.id}`}
                                        >
                                            <FaEye className="text-sm" />
                                            Ver
                                        </Link>
                                        <div>
                                            <BtnExportPdfInvoice invoice={sale} />
                                        </div>
                                    </div>
                                </td>
                            </tr>
